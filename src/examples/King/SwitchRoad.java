...
public class SwitchRoad implements IAction {
    ...
    public Collection<State> apply(State s) {
        ...
        for(int i=0;i<currentState.graphSize;i++){
            ...
            if ((currentState.theGraph[i][currentState.graphCurrentStateIndex]!=0)) {
                ...
                KingGraphState newState = new KingGraphState();
